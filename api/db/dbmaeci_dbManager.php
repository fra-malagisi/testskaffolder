...
function getConnection() {
	...
	global $db_maeci_db_Url, $db_maeci_db_User, $db_maeci_db_Pass, $db_maeci_db_DbName;
	
	try {
		$dbh = new PDO("mysql:host=".$db_maeci_db_Url.";dbname=".$db_maeci_db_DbName, $db_maeci_db_User, $db_maeci_db_Pass);
